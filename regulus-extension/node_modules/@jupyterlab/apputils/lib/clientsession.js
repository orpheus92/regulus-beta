...
var ClientSession = (function () {
    ...
    function ClientSession(options) {
        console.log("==========ClientSession Initialization=========ext");
        this._path = '';
        this._name = '';
        this._type = '';
    ...
    ClientSession.prototype._selectKernel = function () {
        ...
        return _1.showDialog({
            ...
            buttons: [_1.Dialog.cancelButton(), _1.Dialog.okButton({ label: 'SELECT' })]
    ...
    ClientSession.prototype._handleSessionError = function (err) {
        ...
        return _1.showDialog({
            ...
            body: virtualdom_1.h.pre(response),
...
(function (Private) {
     ...
     */
    var KernelSelector = (function (_super) {
