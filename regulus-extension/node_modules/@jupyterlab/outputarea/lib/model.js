...
var OutputAreaModel = (function () {
    ...
    function OutputAreaModel(options) {
        ...
        this.list = new coreutils_1.ObservableList();
        if (options.values) {
     ...
     */
    OutputAreaModel.prototype.set = function (index, value) {
        // Normalize stream data.
        this._normalize(value);
        var item = this._createItem({ value: value, trusted: this._trusted });
     ...
     * Normalize an output.
     */
    OutputAreaModel.prototype._normalize = function (value) {
        if (coreutils_1.nbformat.isStream(value)) {
     ...
     */
    OutputAreaModel.prototype._onSerializedChanged = function (sender, args) {
